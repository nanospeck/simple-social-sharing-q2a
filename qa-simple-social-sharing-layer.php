			...
			$this->output(
				'<div class="qa-sss-buttons">',
					...
					'<div class="qa-sss-final">',
						...
						qa_opt('simple_social_sharing_buttons_tw')?'<a href="https://twitter.com/intent/tweet?original_referer='.$page_url.'&amp;text='.$page_title.'&amp;hashtags=learning,hack,'.$page_tags.'&amp;url='.$page_url.'" rel="external nofollow" target="_blank" class="qa-sss-tw" title="share this question on Twitter">share on tw</a>':'',
